...
<header class="header"  style="background-color:#1b2c5d; padding:30px; text-align:center;">
        @yield('header')
        <h1 style="color:white;">IT FAQs</h1>
        <h4 style="color:white;">Information Technology related questions.</h4>
</header>
